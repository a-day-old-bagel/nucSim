...
//--------- Material definition ---------
  ...
  G4Material *LH2 = new G4Material(
    "LiquidHydrogen", z = 1., a = 1.01 * g/mole, density = 0.07 * g/cm3,
    kStateGas, 3 * kelvin, 1.7e5 * pascal
  );

  G4Material *BadVacuum = new G4Material(
    "Galactic", z = 1.0, a = 1.01 * g/mole, 0., kStateGas, .1 * kelvin,
    1.0e-19 * pascal
  );
